...
export default function Contato() {
  const { locais, telefone, email, horarios } = CONFIG.contato;
  ...
  return (
    <section id="contato" className="contato-section">
      <div className="contato-inner">
        ...
        {/* ── Endereços — uma coluna por local ─────────────────────── */}
        <div className="contato-locais reveal">
          {locais.map((loc, i) => (
            <address
            ...
            >
              {loc.local && (
                <div className="contato-info-group">
                  ...
                  <span className="contato-value">{loc.local}</span>
                </div>
              )}
              ...
              <div className="contato-map">
                <iframe
                  ...
                  title={`Localização — ${loc.local || `Endereço ${i + 1}`}`}
                />
              </div>
            </address>
          ))}
        ...
        {/* ── Ações — WhatsApp, instagram e CTA ────────────────────── */}
        <div className="contato-actions reveal">

          <div className="contato-actions-info">
            <div className="contato-info-group">
